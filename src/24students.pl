...
enrolled_in('Joaquim', 'LAIG').
enrolled_in('Joaquim', 'ESOF').
enrolled_in('Joaquim', 'PLOG').
enrolled_in('Joaquim', 'RCOM').
enrolled_in('Joaquim', 'LTW').

enrolled_in('Zulmira', 'LAIG').
enrolled_in('Zulmira', 'ESOF').
enrolled_in('Zulmira', 'PLOG').
enrolled_in('Zulmira', 'RCOM').
enrolled_in('Zulmira', 'LTW').

enrolled_in('Cristiano', 'LAIG').
enrolled_in('Cristiano', 'ESOF').
enrolled_in('Cristiano', 'PLOG').
enrolled_in('Cristiano', 'RCOM').
enrolled_in('Cristiano', 'LTW').

enrolled_in('Paula', 'LAIG').
enrolled_in('Paula', 'ESOF').
enrolled_in('Paula', 'PLOG').
enrolled_in('Paula', 'RCOM').
enrolled_in('Paula', 'LTW').

enrolled_in('Napoleao', 'LAIG').
enrolled_in('Napoleao', 'ESOF').
enrolled_in('Napoleao', 'PLOG').
enrolled_in('Napoleao', 'RCOM').
enrolled_in('Napoleao', 'LTW').

enrolled_in('Fatima', 'LAIG').
enrolled_in('Fatima', 'ESOF').
enrolled_in('Fatima', 'PLOG').
enrolled_in('Fatima', 'RCOM').
enrolled_in('Fatima', 'LTW').
...
group('ESOF', ['Joaquim', 'Zulmira']).
group('ESOF', ['Paula', 'Cristiano']).
group('ESOF', ['Napoleao', 'Fatima']).
...
group('LAIG', ['Zulmira', 'Paula']).
group('LAIG', ['Cristiano', 'Fatima']).
group('LAIG', ['Napoleao', 'Joaquim']).
...
group('PLOG', ['Zulmira', 'Cristiano']).
group('PLOG', ['Joaquim', 'Fatima']).
group('PLOG', ['Paula', 'Napoleao']).
...
group('LTW', ['Zulmira', 'Cristiano']).
group('LTW', ['Joaquim', 'Fatima']).
group('LTW', ['Paula', 'Napoleao']).
...
group('RCOM', ['Zulmira', 'Cristiano']).
group('RCOM', ['Joaquim', 'Fatima']).
group('RCOM', ['Paula', 'Napoleao']).